  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-3xl flex-col items-center justify-center px-6 text-center">
      ...
      <h1 className="mt-6 font-display text-5xl leading-tight tracking-tight md:text-6xl">
        The Woofback is what we answer the phone as.
        <br />
        <span className="text-blood-bright">The Wolfback is what we are.</span>
      </h1>
      <div className="mt-8 max-w-prose space-y-4 leading-relaxed text-bone-dim">
        <p>
          Two domains, one pack. {SITE.domain} smiles at your customers. {SITE.altDomain} is
          the thing rival agencies check at 2 a.m. to see what just outranked them.
        </p>
        <p>
      ...
      <p className="mt-12 font-mono text-[10px] uppercase tracking-[0.3em] text-bone-faint/60">
        gods · kings · wolves — the top of the page is the top of the page
      </p>
    </div>
  );
}
